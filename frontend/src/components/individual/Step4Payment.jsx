  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 pointer-events-none">
        <div className={`pointer-events-auto w-full max-w-sm rounded-2xl bg-white shadow-2xl border border-slate-200 overflow-hidden transition-all duration-400 ${
            ...
            <div className="px-5 pt-3 pb-3 space-y-3.5">
              ...
              <div>
                ...
                <input type="text" placeholder="Jane Smith" value={name} onChange={e => setName(e.target.value)}
                  className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-900 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100 placeholder:text-slate-400" />
              </div>
              <div>
                ...
                <div className="relative">
                  <input type="text" inputMode="numeric" placeholder="1234 5678 9012 3456"
                    ...
                    className="w-full rounded-lg border border-slate-200 bg-white pl-3 pr-12 py-2.5 text-sm text-slate-900 font-mono outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100 placeholder:text-slate-400 placeholder:font-sans" />
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input type="text" inputMode="numeric" placeholder="MM / YY"
                    ...
                    className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-900 font-mono outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100 placeholder:text-slate-400 placeholder:font-sans" />
                </div>
                <div>
              ...
              <div className="flex items-center gap-1.5 text-[10px] text-slate-400 font-medium pt-0.5">
                <svg className="w-3 h-3 flex-shrink-0 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0 1 12 2.944a11.955 11.955 0 0 1-8.618 3.04A12.02 12.02 0 0 0 3 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016Z" /></svg>
    ...
    <div className="space-y-6">
      ...
      <section className="rounded-[26px] border border-slate-200 bg-slate-50/80 p-5 sm:p-6">
        ...
        <div className="rounded-3xl border border-blue-100 bg-blue-50/80 p-4 text-sm leading-6 text-blue-900 flex items-start gap-2 mb-5">
          ...
          Enter your billing email. A secure card entry window will open on the next step.
        </div>
        <div>
      ...
      <div className="flex flex-col justify-between gap-3 border-t border-slate-100 pt-2 sm:flex-row">
        ...
        <button
          ...
          {submitting ? (
            ...
            <><svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.4"><rect x="2" y="5" width="20" height="14" rx="2" /><path strokeLinecap="round" strokeLinejoin="round" d="M2 10h20" /></svg>Enter Card Details</>
          )}
        </button>
      </div>
    </div>
