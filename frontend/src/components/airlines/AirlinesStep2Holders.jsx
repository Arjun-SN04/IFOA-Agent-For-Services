    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-500">
          Click <span className="font-bold text-slate-700">Add Member</span> to add a team member, or the{' '}
      ...
      {data.subscriptionPlan && (
        <div className="bg-slate-50 border border-slate-200 rounded-xl px-5 py-3 flex items-center justify-between text-sm">
      ...
      {atLimit && (
        <div className="flex items-start gap-3 bg-slate-50 border border-slate-300 rounded-xl p-4 text-sm text-slate-700">
          ...
          <div key={i} id={`holder-card-${i}`} className="rounded-xl border border-gray-200 bg-gray-50/50 overflow-hidden scroll-mt-6">
            ...
            <div className={`px-5 pt-5 space-y-4 ${h.hasSecondaryCertificate ? 'pb-0' : 'pb-4'}`}>
              ...
              <div className="flex flex-col">
                ...
                {h.hasSecondaryCertificate && (
                  <div className="mt-2 mb-4 rounded-xl border border-slate-200 bg-slate-50 pt-3 px-3 pb-4 space-y-3">
      ...
      {/* Actions */}
      <div className="flex gap-3 justify-between mt-4 pt-3 border-t border-gray-100">
