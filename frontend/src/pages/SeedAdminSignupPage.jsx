...
export default function SeedAdminSignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      const res = await fetch('/api/auth/seed-admin-signup', {
        method: 'POST',
    ...
    <div className="h-screen bg-white flex overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-white overflow-y-auto">
        ...
        >
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-black text-slate-900 mb-2">Create Admin Account</h2>
            <p className="text-slate-500 text-sm">Fill in the details to register a new admin.</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-slate-500 text-sm">
              ...
              <Link to="/seed-admin-login" className="text-red-600 font-semibold hover:text-red-700 transition-colors">
                Sign in here
              </Link>
            </p>
          </div>
