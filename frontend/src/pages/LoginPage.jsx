      ...
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10 flex items-center gap-3">
          <div className="flex -space-x-2">
            {['A', 'B', 'C'].map(l => (
              <div key={l} className="w-8 h-8 rounded-full border-2 border-slate-900 bg-blue-600 text-white text-xs font-bold flex items-center justify-center">{l}</div>
            ))}
          </div>
          <p className="text-white/60 text-sm">Trusted by pilots worldwide</p>
        </div>
      </div>
